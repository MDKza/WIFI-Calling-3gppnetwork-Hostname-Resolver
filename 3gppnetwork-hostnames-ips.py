import asyncio     # Import the library for asynchronous programming
import pandas as pd  # Import the library for data manipulation and analysis
from tqdm.asyncio import tqdm  # Import the library for progress bars in async tasks
import socket     # Import the library for low-level network communication
import os         # Import the library for interacting with the operating system
import re         # Import the library for regular expressions (pattern matching)
import requests   # Import the library for making HTTP requests
from bs4 import BeautifulSoup  # Import the library for parsing HTML and XML content
